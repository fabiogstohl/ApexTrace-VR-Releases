...
Version 0.2.0-beta.60 checks the public GitHub Releases API in the background when the
...
This document describes version 0.2.0-beta.60. A future release that adds an online service,
